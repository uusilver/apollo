 ...
 */
public class ChinaCityProvinceGenerator {

    public static void main(String args[]) throws Exception {
        String filePath = ChinaCityProvinceGenerator.class.getClassLoader().getResource("").getPath();
        File file = new File(filePath+"/SPT_MGR_AREA.xls");
        ...
        for(String[] strings : data){
            ...
            Object[] objects = new Object[]{UUID.randomUUID().toString(), strings[3], "", "315kc", "Y", DataHelper.getCurrentTimeStamp()};

            DBHelper.getInstance().insertTable(sql1, list, objects);
        }
        System.out.println("省市数据信息录入完成");
    }
